...
def main():
    ...
    cell_2 = Cell(win, Point(100 + cell_size, 100), Point(100 + 2 * cell_size, 100 + cell_size))
    cell_2.draw()

    cell_3 = Cell(win, Point(100, 100 + cell_size), Point(100 + cell_size, 100 + 2 * cell_size))
    cell_3.draw()

    cell_4 = Cell(win, Point(100 + cell_size, 100 + cell_size), Point(100 + 2 * cell_size, 100 + 2 * cell_size))
    cell_4.draw()
